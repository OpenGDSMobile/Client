 module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            build: {
                src: 'js/openGDSMobile/openGDSMobileClient1.0.js', //uglify할 대상 설정
                dest: 'js/openGDSMobile/openGDSMobileClient1.0.min.js' //uglify 결과 파일 설정
            }
        },
        //concat 설정
        concat:{
            basic: {
                src: ['js/openGDSMobile/settingValues.js','js/openGDSMobile/MapConfig.js',
                     ...
                     'js/openGDSMobile/openGDSMSeoulOpenData.js','js/openGDSMobile/openGDSMPublicOpenData.js',
